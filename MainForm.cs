...
namespace FXStreamer
{
    public partial class MainForm : Form
    {
        ...
        protected string mAcquisitionDurationUnits = "spectra";  // seconds, minutes, hours, spectra
        ...
        protected string mSaveRangeUnits = "wavelengths";  // pixels, wavelengths
        ...
        protected void doDeviceInitialization()
        {
            ...
            mTriggerMode = 2;  // Override the actual setting with a default of 2
            ...
            mBufferEnabled = 0;  // Override the actual setting with unenabled
